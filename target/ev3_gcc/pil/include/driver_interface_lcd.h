 ...
 */
static inline
ER bmpfile_read_header(const void *bmpfile, uint32_t bmpfilesz, int32_t *p_width, int32_t *p_height) {
	ER ercd;
 ...
 */
static inline
ER bmpfile_to_bitmap(const void *bmpfile, uint32_t bmpfilesz, bitmap_t *bitmap) {
	ER ercd;
